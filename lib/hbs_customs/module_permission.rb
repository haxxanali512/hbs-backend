      ...
      def tenant_permissions
        {
          ...
          clinical_documentations: DEFAULT_CRUD.merge(sign: false, cosign: false, amend: false, export_pdf: false, preview: false),
      ...
      def admin_permissions
        {
          ...
          clinical_documentations: { index: false, show: false, void_readonly: false, export_pdf: false, preview: false },
          provider_notes: DEFAULT_CRUD,
          patients: DEFAULT_CRUD,
          patient_insurance_coverages: DEFAULT_CRUD.merge(activate: false, terminate: false, replace: false, run_eligibility: false),
