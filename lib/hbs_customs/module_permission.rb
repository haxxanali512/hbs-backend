      ...
      def admin_permissions
        {
          ...
          referral_partners: DEFAULT_CRUD.merge(approve: false, deny: false, suspend: false),
          referral_partner_applications: { index: false, show: false, approve: false, deny: false, update: false },
