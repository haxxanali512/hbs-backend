class PatientInsuranceCoverage < ApplicationRecord
  ...
  def plan_must_be_accepted_by_org
    nil unless organization && insurance_plan

    # TODO: Check org_accepted_plans when implemented
    # unless organization.org_accepted_plans.active.exists?(insurance_plan_id: insurance_plan_id)
